...
{ 
    static EncodingTable[] encodingTable  = new EncodingTable[]
    {
        new EncodingTable("Afrikaans","",           0x0436, 1252,   0,      "CP1252"    ),
            ...
            new EncodingTable("Arabic", "United Arab Emirates", 0x3801, 1256,   178,    "CP1256"    ),
    ...
    public static int findCodePage(int lcid) {
        for (int i = 0; i < encodingTable.length; ++i) {
            if (encodingTable[i].lcid == lcid) {
                return encodingTable[i].codepage;
            }
        }
        return 0;
    } 
    ...
    public static String findCharset(int lcid) {
        for (int i = 0; i < encodingTable.length; ++i) {
            if (encodingTable[i].lcid == lcid) {
                return encodingTable[i].charset;
            }
        }
        return "English";        
    }
    ...
    public static String findCountry(int lcid) {
        for (int i = 0; i < encodingTable.length; ++i) {
            if (encodingTable[i].lcid == lcid) {
                return encodingTable[i].country;
            }
        }
        return "";        
    }
    ...
    public static int findICharset(int lcid) {
        for (int i = 0; i < encodingTable.length; ++i) {
            if (encodingTable[i].lcid == lcid) {
                return encodingTable[i].icharset;
            }
        }
        return 0;        
    }
